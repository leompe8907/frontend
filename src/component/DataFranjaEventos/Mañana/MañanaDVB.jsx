...
function MañanaDVB({ responseData }) {
  const chartRef = useRef(null);
  const chartInstance = useRef(null);
  // Asumimos que responseData.franjahorariaeventdvb.Mañana es el objeto proporcionado
  const Mañana = responseData.franjahorariaeventodvb?.Mañana;
