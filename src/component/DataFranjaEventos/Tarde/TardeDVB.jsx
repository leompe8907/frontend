...
function TardeDVB({ responseData }) {
  const chartRef = useRef(null);
  const chartInstance = useRef(null);
  // Asumimos que responseData.franjahorariaeventdvb.Tarde es el objeto proporcionado
  const Tarde = responseData.franjahorariaeventodvb?.Tarde;
