...
function NocheDVB({ responseData }) {
  const chartRef = useRef(null);
  const chartInstance = useRef(null);
  // Asumimos que responseData.franjahorariaeventdvb.Noche es el objeto proporcionado
  const Noche = responseData.franjahorariaeventodvb?.Noche;
