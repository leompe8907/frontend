...
function MadrugadaOTT({ responseData }) {
  ...
  // Asumimos que responseData.franjahorariaeventott.Madrugada es el objeto proporcionado
  const Madrugada = responseData.franjahorariaeventott?.Madrugada;
